...
Adapted: `subagent_type` points at the plugin-namespaced agent `oss:comment-sicko`
...
1. Spawn `Task` with `subagent_type: "oss:comment-sicko"`. Pass the scope. Do not restate its rules.
