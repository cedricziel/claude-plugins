...
<!--
Vendored verbatim from https://github.com/cursor/plugins/blob/b047069f4f3a73e87dd1f11f7913386d25876b91/pstack/skills/technical-writing/SKILL.md
(pstack by Lauren Tan, MIT — see LICENSE in this directory). Depends on the
`unslop` skill, vendored from the same repo into the `common` plugin (common:unslop).
To resync: fetch the file at the newest commit and update the SHA above.
-->
