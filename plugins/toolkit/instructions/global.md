...
- After opening a PR, keep polling for automated reviews (e.g. CodeRabbit) and CI, act on their findings, and continue iterating until green — unless the user says otherwise or the task shifts away.
